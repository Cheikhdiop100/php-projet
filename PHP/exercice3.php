...
<body>
    <header>
        <h1>Exercice 3</h1>
        <p>Tirages aléatoires pour obtenir un nombre</p>
    </header>

    <section>
        <h2>Simulation de Tirages</h2>
        <form method="post">
            <label for="nombre">Saisissez un nombre à trois chiffres :</label>
            <input type="number" id="nombre" name="nombre" min="100" max="999" placeholder="Entrez un nombre ici" required>
