...
<body>
    <header>
        <h1>Exercice 1</h1>
        <p>Vérifiez si un mot est un palindrome</p>
    </header>
    ...
    <section>
        ...
        <form method="post">
            ...
            <input type="text" id="mot" name="mot" placeholder="Entrez un mot ici" required>
            <button type="submit">Vérifier</button>
        </form>

        <?php
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $mot = htmlspecialchars($_POST['mot']); // Protection contre les injections
            $reverse = strrev($mot);
            if ($mot === $reverse) {
