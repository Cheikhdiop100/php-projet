...
<body>
    <header>
        <h1>Exercice 2</h1>
        <p>Tester si un nombre est multiple de 3 et 5</p>
    </header>

    <section>
        <h2>Vérification des Multiples</h2>
        <form method="post">
            <label for="nombre">Saisissez un nombre :</label>
            <input type="number" id="nombre" name="nombre" placeholder="Entrez un nombre ici" required>
